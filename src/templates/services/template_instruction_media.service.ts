...
export class TemplateInstructionMediaService {
    constructor(
        ...
        @Inject(TemplateInstructionMediaRepositoryImpl) private readonly templateInstructionMediaRepository: TemplateInstructionMediaRepository
    ) {}
    ...
    async create(createTemplateInstructionMediaDto: CreateTemplateInstructionMediaDto) {
        try {
            ...
            const uploadResponse = await firstValueFrom(
                this.httpService.post('/api/cloudinary/upload',formData, {
                    headers: {
                        ...formData.getHeaders()
                    }
                })
            ...
            const templateInstructionMedia = new TemplateInstructionMedia(pathFile, createTemplateInstructionMediaDto.template, createTemplateInstructionMediaDto.typeMedia);
            const templateInstructionMediaSaved = await this.templateInstructionMediaRepository.create(templateInstructionMedia);
